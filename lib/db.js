...
async function initDb() {
  ...
  if (!cols.includes('prey_insect')) db.run(`ALTER TABLE insects ADD COLUMN prey_insect TEXT DEFAULT ''`);
  if (!cols.includes('predator_stage')) db.run(`ALTER TABLE insects ADD COLUMN predator_stage TEXT DEFAULT ''`);
  db.run(`
